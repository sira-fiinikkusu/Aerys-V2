...
ACTION_OVERLAY = (
    ...
    "substitute a remembered or guessed value. If a search finds nothing, try "
    "ONE synonym or the device's brand/name before giving up (solar -> 'envoy' "
    "or 'production'; the car -> its name; a room's climate -> 'temperature'). "
    "Read-only questions are yours too: when the "
